...
public class Sequence {
	...
	public synchronized long nextId() {
		...
		System.out.println("datacenterIdShift   "+datacenterIdShift);
		System.out.println("workerId            "+workerIdShift);
		System.out.println("sequence            "+timestamp);
		...
		System.out.println("(workerId << workerIdShift)  "+((workerId << workerIdShift)));
